...
| PatchPilot provider campaigns, atomic consent grant/list/revoke with retained history, Ed25519 manifests, public Action v0.19.0, main v0.20.0, 127 tests, no-execution guarantee | `patchpilot/README.md`, `docs/provider-campaigns.md`, v0.20.0 release and CI at commit `61f4159` |
